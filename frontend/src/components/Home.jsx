...
const todoStatus = async (id) => {
 ...
 const todoDelete = async (id) => {
  ...
  return (
   <div className =" my-10 bg-gray-100 max-w-lg lg:max-w-xl rounded-lg mx-8 sm:mx-auto p-6">
  ...
  <div className="flex mb-4">
    ...
    <button onClick={todoCreate} className="bg-blue-600 border rounded-md text-white px-4 py-2 hover:bg-blue-900 duration-300">
      Add
    </button>
  </div>
  {loading?(<div className= " text-center justify-center"> Loading....</div>):error ?(<div className ="text-center text-red-600 font-semibold"> {error}</div>): (
 <ul className="space-y-2">
  ...
  <button onClick={() => logout()}  className="mt-6 px-4 bg-red-500 text-white rounded-md hover:bg-red-800 duration-500 mx-auto block">
    Logout
  </button>
</div>
  )
